...
public interface OfferRepository extends CrudRepository <Offer,Integer>{
	...
	@Query("SELECT count(*) FROM Offer o"
		 + " WHERE o.Kindergarten.userapp.id =:userid AND o.product.id=:productid")
    public int CheckProduct(@Param("userid") long userid, @Param("productid")int productid);
	
	@Query("SELECT count(*) FROM Offer o"
			 + " WHERE o.Kindergarten.userapp.id =:userid")
	...
	@Query("SELECT o FROM Offer o WHERE o.Kindergarten.userapp.id =:id GROUP BY o.product")
